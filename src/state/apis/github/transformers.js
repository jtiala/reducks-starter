...
export const transformRepository = repository => Repository({
  ...repository,
...
// Requests
export const getRepositories = payload => (Array.isArray(payload)
  ? OrderedSet(payload.map(transformRepository))
  : OrderedSet());
